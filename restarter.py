...
class HikkaRestartMod(loader.Module):
    ...
    strings_ru = {
        ...
        "restarting_caption": (
            "<emoji document_id=6318970114548958978>🕗</emoji> <b>Твой Lp Sakurai"
            " перезагружается...</b>"
        ),
        "success": (
        ...
        "cancel": "🚫 Отмена",
        "_cls_doc": "Перезапускает Lp Sakurai",
    }
    ...
    async def source(self, message: Message):
        ...
        await utils.answer(
            message,
            self.strings("source").format("https://github.com/Telegram1995/Lp_Sakurai"),
        )
                    ...
                    DialogFilter(
                        ...
                        include_peers=[
                            ...
                            and (
                                ...
                                and dialog.name in {"Sakurai-logs", "silent-tags"}
                            )
                            or (
